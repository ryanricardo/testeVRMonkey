...
hardInput.GetKey("Forward")		=	 hardInput.GetKey("Forward")
hardInput.GetKeyDown("Jump")		=	 hardInput.GetKeyDown("Jump")
hardInput.GetAxis("Forward", "Backward", 1)		=	 hardInput.GetAxis("Forward", "Backward", 1)
hardInput.GetAxis("Forward", "Backward", 1)		=	 hardInput.GetAxis("Forward", 1)
